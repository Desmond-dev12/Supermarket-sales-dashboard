...
if section == "About":
    ...
    st.info("Current Sprint:** Building end-to-end data pipelines using SQL, Pandas, and Streamlit")
...
#            EXPERIENCE SECTION
    ...
    with st.expander("Streamlit Data web Application (Current)"):
        st.write(""" * Designed an interactive multi-page web application
    using Python and Streamlit. * Implemented dynamic filtering 
    and custom data processing with pandas.* 
    Structure optimized for rapid deployment and user 
    navigation.""")

    with st.expander("Excel & Exploratory Data Analysis Practice, & Visualization"):
...
#            EDUCATION SECTION
    ...
    st.write(""" * **Core Focus:** Information systems, Data Analytics,
            ...
            * **Relevance Coursework: **
            Statistics, Computer Architecture, system Design,
            Database Management""")
